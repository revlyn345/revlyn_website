/* ═══════════════════════════════════════════════════════════════
   Deliberately NOT "use client". Only three things on this page need
   client state (the before/after tab, one FAQ accordion item, and the
   mouse-tracking CTA spotlight) - those now live in ./HubSpotAuditWidgets
   as Client Components. Everything else here (hero, deliverable list,
   audience list, testimonial, footer) is static and now renders as
   plain HTML on the server instead of shipping as JS to hydrate.
   ═══════════════════════════════════════════════════════════════ */
