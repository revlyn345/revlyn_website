  ...
  return (
    <footer className="bg-ink text-paper">
      <div className="max-w-[1400px] mx-auto px-6 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="mono text-[11px] uppercase tracking-[0.22em] text-paper/60">
          Revlyn · Certified Bitscale implementation partner
        </div>
        <div className="flex flex-wrap gap-5 mono text-[11px] uppercase tracking-[0.22em]">
          <Link href="/" className="hover:text-fire transition-colors">Home</Link>
          <Link href="/partners/bitscale" className="hover:text-fire transition-colors">Partnership</Link>
          <Link href="/work" className="hover:text-fire transition-colors">Work</Link>
